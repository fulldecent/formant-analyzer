...
class FirstViewController: UIViewController {
    ...
    func drawSignalPlot() {
        ...
        let plottableValuesHigh: [Double] = self.speechAnalyzer.downsampleToSamples(400) as! [Double]
    ...
    func drawLPCPlot() {
        ...
        let lpcCoefficients: [Double] = self.speechAnalyzer.lpcCoefficients() as! [Double]
    ...
    func drawHwPlot() {
        ...
        // Grid parameters
        self.lineChartFull.drawInnerGrid = true
        let synthesizedFrequencyResponse: [Double] = self.speechAnalyzer.synthesizedFrequencyResponse() as! [Double]
        self.lineChartFull.clearChartData()
    ...
    func displayFormantFrequencies() {
        var formants: [Double] = self.speechAnalyzer.findCleanFormants() as! [Double]
    ...
    func processRawBuffer() {
        ...
        self.speechAnalyzer = SpeechAnalyzer(data: speechData)
        self.showPlotForDisplayIdentifier(self.displayIdentifier, withAnalyzer: self.speechAnalyzer)
    }
    ...
    func readSoundFileSamples(filePath: String) -> NSData {
        ...
        while reader.status != .Completed {
            ...
            var outBytes = NSMutableData(length: size)!
...
extension FirstViewController: FDSoundActivatedRecorderDelegate {
    ...
    func soundActivatedRecorderDidStopRecording(recorder: FDSoundActivatedRecorder!, andSavedSound didSave: Bool) {
        ...
        if didSave {
            ...
            self.speechAnalyzer = SpeechAnalyzer(data: self.speechData)
            self.showPlotForDisplayIdentifier(self.displayIdentifier, withAnalyzer: self.speechAnalyzer)
